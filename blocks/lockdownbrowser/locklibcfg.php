...
// ----- never edit these
define('LDB_SERVERNAME', 'AdjusterPro+Secure+Exams');
define('LDB_SERVERID', '706137969');
define('LDB_SERVERSECRET', 'j6iY55pdqQ9zOMeA');
define('LDB_SERVERTYPE', '0');
define('LDB_DOWNLOAD', 'https://download.respondus.com/lockdown/download.php?id=706137969');
